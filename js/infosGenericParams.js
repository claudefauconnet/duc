var infosGenericParams = (function () {
    ...
    var treeModels = {
        "scenarioXX": {
            join: [{model: "scenarios", key: "UC_id"}, {model: "technologies", key: "UC_id"}]
        }
        ,
        ...
        "business": {
            ...
            model: [{
                ...
                },
                {
                 ...
                 text: "UC_name",
                 id: "UC_id",
                 icon: iconPath + Gparams.customIcons["POT"]["use_cases"],
                 }*/]
        }
        ,
        ...
        "technologies": {
            ...
            model: [{
                ...
                text: "techno_name",
                id: "techno_id",
                icon: iconPath + Gparams.customIcons["POT"]["technologies"]
